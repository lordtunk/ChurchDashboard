    ...
    class Person {
        ...
        public function insert($user_id) {
            ...
            if($this->has_name) {
                ...
                $this->id = $this->f->queryLastInsertId($query, array(":last_name"=>$person->last_name, ":first_name"=>$person->first_name, ":adult"=>$person->adult, ":user_id"=>$user_id));
            }
        }
        ...
        private function validate() {
            if($this->first_name == "" && $this->last_name == "" && $this->display == "")
